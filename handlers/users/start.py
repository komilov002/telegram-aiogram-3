...
from keyboards.reply.buttons import menyu
...
async def do_start(message: types.Message):
    ...
    await message.answer(f"Assalomu alaykum {make_title(full_name)}\!", parse_mode=ParseMode.MARKDOWN_V2, reply_markup=menyu)
